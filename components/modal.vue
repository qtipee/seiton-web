                    ...
                    <TransitionChild as="template" enter="ease-out duration-300" enter-from="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" enter-to="opacity-100 translate-y-0 sm:scale-100" leave="ease-in duration-200" leave-from="opacity-100 translate-y-0 sm:scale-100" leave-to="opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95">
                            ...
                            <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                <div class="sm:flex sm:items-start">
                                    <div class="mx-auto flex size-12 shrink-0 items-center justify-center rounded-full bg-blue-100 sm:mx-0 sm:size-10">
                                        <IconsInformationCircle v-if="type === ModalType.INFO" class="size-6 text-blue-600" />
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                            <button
                                ...
                                @click="$emit('accepted', true); $emit('update:open', false)"
                            >
                                {{ approveText }}
                            </button>
                            <button
                                ...
                                @click="$emit('accepted', false); $emit('update:open', false)"
                            >
                                Annuler
                            </button>
                        </div>
